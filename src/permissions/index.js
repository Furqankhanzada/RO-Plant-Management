...
const permissions = shield({
    Query: {
        ...
        transactions: and(rules.isAuthenticated, rules.isAdmin),
        transaction: and(rules.isAuthenticated, rules.isAdmin),
    ...
    Mutation: {
        ...
        updateProduct: and(rules.isAuthenticated, rules.isAdmin),
    },
});
